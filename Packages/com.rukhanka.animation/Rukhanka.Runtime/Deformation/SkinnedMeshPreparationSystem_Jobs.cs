...
struct RegisterNewSkinnedMeshesJob: IJob
{
	...
	[NativeDisableUnsafePtrRestriction]
	public UnsafeAtomicCounter32 maximumBoneWeightCountAcrossAllRegisteredMeshes;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public unsafe void Execute()
	{
		...
		foreach (var sm in newSkinnedMeshes)
		{
			...
			maximumBoneWeightCountAcrossAllRegisteredMeshes.Reset(math.max(numBoneWeightIndicesCount, *maximumBoneWeightCountAcrossAllRegisteredMeshes.Counter));
