...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void CopyNewMeshesToInitialMeshDataBuffer(in DeformationRuntimeData drd)
	{
		...
		var maxDataUploadSize = drd.maximumBoneWeightCountAcrossAllRegisteredMeshes * UnsafeUtility.SizeOf<BoneWeight1>();
		var tsu = sparseUploader.Begin(boneWeightDataSize, maxDataUploadSize, drd.newSkinnedMeshesToRegister.Count());
