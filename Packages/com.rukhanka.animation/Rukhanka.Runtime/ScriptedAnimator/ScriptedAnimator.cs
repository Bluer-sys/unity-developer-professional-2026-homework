...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// <param name="normalizedTime">Normalized time (0 - beginning of the state, 1 - end of the state) of state to play.</param>
    /// <param name="stateWeight">Weight of current state.</param>
    /// <param name="layerWeight">Weight of current layer.</param>
    /// <param name="avatarMask">Optional avatar mask to use with state animations.</param>
    ...
    )
    {
        ...
        var animationStartIndex = atps.Length;
        ...
        //  Set layer runtime info for all added animations
        for (int i = animationStartIndex; i < atps.Length; ++i)
        {
            ref var atp = ref atps.ElementAt(i);
            atp.layerIndex = layerIndex;
            atp.layerWeight = layerWeight;
        }
    }
