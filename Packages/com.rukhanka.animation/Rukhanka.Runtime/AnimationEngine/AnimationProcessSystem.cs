...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	JobHandle PrepareComputationData(ref SystemState ss, NativeArray<int> chunkBaseEntityIndices, ref RuntimeAnimationData runtimeData, NativeList<Entity> entitiesArr, JobHandle dependsOn)
	{
		...
		//	Reset runtime data for disabled rigs
		var resetDisabledRigsRuntimeDataJob = new ResetDisabledRigsRuntimeDataJob();
		var resetDisabledRigsRuntimeDataJH = resetDisabledRigsRuntimeDataJob.Schedule(boneToEntityJH);
		return resetDisabledRigsRuntimeDataJH;
	}
