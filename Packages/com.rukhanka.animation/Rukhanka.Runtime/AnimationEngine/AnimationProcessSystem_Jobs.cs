...
[BurstCompile]
[WithDisabled(typeof(RigDefinitionComponent))]
partial struct ResetDisabledRigsRuntimeDataJob: IJobEntity
{
	void Execute(ref RigDefinitionComponent rdc)
	{
		rdc.dynamicFrameData = DynamicFrameData.MakeInvalid();
	}
}
