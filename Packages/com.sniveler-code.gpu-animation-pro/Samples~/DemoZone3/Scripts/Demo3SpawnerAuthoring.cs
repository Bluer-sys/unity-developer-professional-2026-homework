...
namespace SnivelerCode.GpuAnimation.DemoZone3
{
    ...
    public struct Demo3DebugBlueArcherTag : IComponentData
    {
    }

    public struct Demo3DebugRedArcherTag : IComponentData
    {
    }
    ...
    public sealed class Demo3SpawnerAuthoring : MonoBehaviour
    {
        ...
        private sealed class Baker : Baker<Demo3SpawnerAuthoring>
        {
            public override void Bake(Demo3SpawnerAuthoring data)
            {
                ...
                switch (data.faction)
                {
                    case Demo3Faction.Blue when data.prefab.Type == Demo3UnitType.Archer:
                        AddComponent<Demo3DebugBlueArcherTag>(entity);
                        break;

                    case Demo3Faction.Red when data.prefab.Type == Demo3UnitType.Archer:
                        AddComponent<Demo3DebugRedArcherTag>(entity);
                        break;
