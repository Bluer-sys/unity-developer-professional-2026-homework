...
namespace SnivelerCode.GpuAnimation.Editor.Window
{
    public sealed class LodInstance
    {
        ...
        public Quality SkinningQuality;
                ...
                for (int i = 0; i < unityLods.Length; i++)
                {
                    ...
                    if (lodRenderers.Length > 0)
                    {
                        Lods.Add(new LodInstance
                        {
                            ...
                            Skins = lodRenderers,
                            SkinningQuality = i switch
                            {
                                0 => LodInstance.Quality.Bones4,
                                1 => LodInstance.Quality.Bones2,
                                _ => LodInstance.Quality.Bones1
                            },
                            Interpolation = i < 2,
                            Shadows = i < 2
                        });
            ...
            else
            {
                ...
                if (lodRenderers.Length > 0)
                {
                    Lods.Add(new LodInstance
                    {
                        Percent = 60,
                        Skins = lodRenderers,
                        SkinningQuality = LodInstance.Quality.Bones4,
                        Interpolation = true,
                        Shadows = true
                    });
                }
