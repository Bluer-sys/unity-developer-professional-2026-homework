    ...
    public sealed class GenerateProcessor
    {
        ...
        public async Task GenerateAnimationAsset(PrefabInstance instance)
        {
            ...
            try
            {
...
#elif UNITY_2023_1_OR_NEWER || UNITY_6000_0_OR_NEWER
                ...
                bufferAsset.MatricesDqs = bakeResult.BakedMatricesDqs.ToArray();
                bufferAsset.MatricesLbs = bakeResult.BakedMatricesLbs.ToArray();
                bufferAsset.IsDqs = instance.UseDqs;
                ...
                animatorComponent.Bones = bakeResult.MonoBones;
