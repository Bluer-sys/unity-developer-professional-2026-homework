...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Tools/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Tools/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
